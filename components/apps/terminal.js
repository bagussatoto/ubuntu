...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            projects: ["niclas-personal-portfolio", "synonyms-list-react", "economist.com-unlocked", "Improve-Codeforces", "flutter-banking-app", "Meditech-Healthcare", "CPU-Scheduling-APP-React-Native"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className="text-ubt-green">bagus@UbuntuOS</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/nicholas")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-nicholas, about-resume, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-nicholas":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-nicholas");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-nicholas, about-resume, todoist, trash, settings, sendmsg ]";
                }
                break;
            case "about-resume":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-resume");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-nicholas, about-resume, todoist, trash, settings, sendmsg ]";
                }
                break;
            ...
            case "sudo":
                ...
                result = "<img class='w-1/3' src='./images/memes/used-sudo-command.png' />";
                break;
            default:
                result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-nicholas, about-resume, todoist, trash, settings, sendmsg ]";
        }
